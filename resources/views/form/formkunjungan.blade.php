            ...
            <div class="col-md-7">
                <div class="card shadow rounded-4">
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ route(Session::has('pasien') ? 'pasien.kunjungan.store' : 'admin.kunjungan.store') }}">
                            @csrf
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="spinner-border spinner-border-sm text-secondary position-absolute top-50 end-0 me-4 d-none"
                                        id="loading-layanan" style="transform: translateY(-50%);" role="status"></div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="pilih_tanggal" id="tanggal" class="form-control"
                                        placeholder="Klik untuk memilih" required disabled>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="spinner-border spinner-border-sm text-secondary position-absolute top-50 end-0 me-4 d-none"
                                        id="loading-dokter" style="transform: translateY(-50%);" role="status"></div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="spinner-border spinner-border-sm text-secondary position-absolute top-50 end-0 me-4 d-none"
                                        id="loading-jam" style="transform: translateY(-50%);" role="status"></div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="keluhan" id="keluhan" rows="3" class="form-control" required
                ...
                fetch('/get-jam-by-dokter', {
                    ...
                    .then(jamList => {
                        jamList.forEach(j => {
                            ...
                            opt.value = j.jam;
                            opt.text =
                                `${j.jam} (Ruangan: ${j.ruangan_nama}, Sisa: ${j.sisa_kuota})`;
